...
echo "<script>alert('No se registrar algo salió mal');</script>";
}
}
// Code for User login
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				<li><a href="home.html">Incio</a></li>
...
<div class="col-md-6 col-sm-6 create-new-account">
	...
	<p class="text title-tag-line">Crea tu propia cuenta.</p>
...
<div class="form-group">
	    	<label class="info-title" for="contactno">No. de contacto <span>*</span></label>
...
<div class="form-group">
	...
	<div class="checkbox">
	  	<label class="checkbox">
		  	Acelere su camino a través del pago.
		</label>
		<label class="checkbox">
