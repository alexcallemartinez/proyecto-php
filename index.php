...
if(isset($_GET['action']) && $_GET['action']=="add"){
	...
	if(isset($_SESSION['cart'][$id])){
		...
		if(mysqli_num_rows($query_p)!=0){
			...
			$message="ID invalido del producto ";
		}
	}
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">Envió gratis</h4>
						</div>
					</div>
					<h6 class="text">ENVÍO GRATIS COMPRAS MAYOR A 600,00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">TODOS LOS ARTÍCULOS-VENTA HASTA UN 20% DE DESCUENTO</h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Productos Destacados</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#furniture" data-toggle="tab">Mueble</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
	...
	<div class="product">		
		<div class="product-image">
			<div class="image">
				...
				<img  src="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>" data-echo="admin/productimages/<?php echo htmlentities($row['id']);?>/<?php echo htmlentities($row['productImage1']);?>"  width="265" height="265" alt=""></a>
			</div><!-- /.image -->			
		...
		<?php if($row['productAvailability']=='Disponible'){?>
					<div class="action text-center"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Agregar a carrito</a></div>
				<?php } else {?>
							...
							<div class="product-micro">
								<div class="row product-micro-row">
									...
									<div class="col col-xs-6">
										...
										<?php if($row['productAvailability']=='In Stock'){?>
					<div class="action"><a href="index.php?page=product&action=add&id=<?php echo $row['id']; ?>" class="lnk btn btn-primary">Agregar carrito</a></div>
				<?php } else {?>
						<div class="action" style="color:red">Agotado</div>
					<?php } ?>
										</div>
