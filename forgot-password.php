...
<html lang="es">
	<head>
	    ...
	    <title>Shopping Portal | Olvidó la contraseña</title>
	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
				...
				<li class='active'>Se te olvidó tu contraseña</li>
			</ul>
...
?>
		...
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    <label class="info-title" for="exampleInputPassword1">N° de contacto <span>*</span></label>
