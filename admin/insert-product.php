                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="productCompany"
                                                placeholder="Ingresar nombre la marca" class="span8 tip" required>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="basicinput">Precio del producto antes del
                                            descuento
                                        </label>
                                        <div class="controls">
                                            <input type="text" name="productpricebd" placeholder="Precio anterior"
                                                class="span8 tip" required>
                                        </div>
                                    </div>

                                    <div class="control-group">
                                        <label class="control-label" for="basicinput">Precio del producto después del
                                            descuento (precio de venta)
                                        </label>
                                        <div class="controls">
                                            <input type="text" name="productprice" placeholder="Precio de venta"
                                                class="span8 tip" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="productShippingcharge"
                                                placeholder="Ingrese el costo de envío" class="span8 tip" required>
                                        </div>
                                    </div>
