...
$_SESSION['msg']="Imagen de producto actualizada correctamente!!";
...
{?>
									...
									<strong>Conforme!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">Nuevo producto imagen 1</label>
<div class="controls">
