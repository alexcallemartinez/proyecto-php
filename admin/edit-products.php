...
<div class="control-group">
<label class="control-label" for="basicinput">Descripcion del producto
</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Costo de envío
</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Stock
</label>
<div class="controls">
