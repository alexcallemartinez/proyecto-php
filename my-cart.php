...
// code for billing address updation
	if(isset($_POST['update']))
	{
		...
		if($query)
		{
echo "<script>alert('Se actualizó la dirección de facturación');</script>";
		}
	}
...
// code for Shipping address updation
	if(isset($_POST['shipupdate']))
	{
		...
		if($query)
		{
echo "<script>alert('La dirección de envío se ha actualizado');</script>";
		}
	}
		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-sub-total item">Precio unidad</th>
	...
	?>
				...
				<tr>
					...
					<td class="cart-product-name-info">
						<h4 class='cart-product-description'><a href="product-details.php?pid=<?php echo htmlentities($c=$row['id']);?>" ><?php echo $row['productName'];
...
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo "S/"." ".$row['shippingCharge']; ?>.00</span></td>
					...
					<td class="cart-product-grand-total"><span class="cart-grand-total-price"><?php echo "S/".($_SESSION['cart'][$row['id']]['quantity']*$row['productPrice']+$row['shippingCharge']); ?>.00</span></td>
				</tr>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Dirección de facturacion</span>
				</th>
			</tr>
		</thead>
		<tbody>
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Dirección de facturacion<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Distrito  <span>*</span></label>
			 <input type="text" class="form-control unicase-form-control text-input" id="bilingstate" name="bilingstate" value="<?php echo $row['billingState'];?>" required>
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Billing City">Departamento <span>*</span></label>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						Total <span class="inner-left-md"><?php echo "S/". $_SESSION['tp']="$totalprice". ".00";?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
		<tbody>
				<tr>
					<td>
					   ...
					   <button type="submit" name="ordersubmit" class="btn btn-primary">Procesar Pedido</button>
...
<script>
	...
	client: {
        sandbox:    'ASf--WAoU32oofkCKDjmW4SuYSbfDANVjhV3vWMlgwOIS-0ZIRKBl6UqbuaQS3YtZTCFva1GjKXJezSi',
